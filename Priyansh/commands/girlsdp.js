...
"https://i.imgur.com/PqD8g7j.jpeg",
  ...
  var callback = () => api.sendMessage({ body: `ہم جو آگئے پہلو میں تو ہوش کہاں سے لاؤگے😊❤️𝐃𝐚𝐧𝐢 𝐗 𝐌𝐢𝐬𝐡𝐢`, attachment: fs.createReadStream(__dirname + "/cache/5.jpg") }, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg"));
