...
module.exports.run = async function ({ api, event, args, Users }) {
  ...
  let getImage = (
    await axios.get(encodeURI(`https://i.imgur.com/m2qmTrp.jpg`, `https://i.imgur.com/m2qmTrp.jpg`, `https://i.imgur.com/kdnQhXC.jpg`, `https://i.imgur.com/WNmeEl7.jpg`, `https://i.imgur.com/XhW3H25.jpg`), {
...
if(!fs.existsSync(__dirname+'/cache/SVN-Arial 2.ttf')) { 
  ...
  ctx.font = "80px SVN-Arial 2";
  ctx.fillStyle = "#893F45";
  ctx.textAlign = "center";
  const line = await this.wrapText(ctx, text[0], 600);
